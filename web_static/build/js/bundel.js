...
function _templateObject11() {
  var data = _taggedTemplateLiteral(["<div class=\"error\">The server had an error handling the response headers</div>"]);
...
var popup = function popup() {
  return !pData.showPopup ? Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject3()) : Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject4(), closePopup, function () {
    ...
    pData.onTab = 3;
    r();
  }, pData.onTab == 0 ? Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject5(), pData.firstloadReq.url, pData.firstloadReq.type, pData.firstloadReq.code) : pData.onTab == 1 ? Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject6(), pData.hasLoaded ? Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject7(), pData.req.requestHeaders ? Object.keys(pData.req.requestHeaders).map(function (el) {
    return Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject8(), el, pData.req.requestHeaders[el]);
  }) : Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject9()), pData.req.responseHeaders ? Object.keys(pData.req.responseHeaders).map(function (el) {
    return Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject10(), el, pData.req.responseHeaders[el]);
  }) : Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject11())) : Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject12())) : pData.onTab == 2 ? Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject13(), pData.hasLoaded ? Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject14(), pData.req.resData) : Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject15())) : pData.onTab == 3 ? Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject16(), pData.firstloadReq.type != 'POST' ? Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject17()) : pData.hasLoaded ? Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject18(), nicifyOutput(pData.req.postBody)) : Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject19())) : Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject20()));
};

var getList = function getList() {
  return Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject21(), lastReqests.length ? lastReqests.map(function (req) {
    return Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject22(), function () {
      return loadPopupData(req);
    }, req.pkg, extItem(req.pkg, 'Small.name'), moreIcon, statusColor(req.code), req.type, req.code, req.url);
  }) : dataLoaded ? Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject23()) : Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject24()));
};

var toRender = function toRender() {
  return Object(lit_html__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject25(), popup(), getList());
};
